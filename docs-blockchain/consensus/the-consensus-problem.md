...
<figure><img src="../.gitbook/assets/P2P_vs_client-server.svg" alt=""><figcaption></figcaption></figure>
...
* In a **client-server network**, the server is the leader; the authoritative resource
* On a **peer-to-peer network** centralized authority is implemented at the protocol level, rather than at the network architecture level.
{% endhint %}
